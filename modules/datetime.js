...
import { parseFromTokens, explainFromTokens, formatOptsToTokens, expandMacroTokens } from './impl/tokenParser.js';
import {
  gregorianToWeek,
  weekToGregorian,
  gregorianToOrdinal,
...
export default class DateTime {
  ...
  toISOTime({
    ...
    return (
      c + toISOTime(this, format === 'extended', suppressSeconds, suppressMilliseconds, includeOffset, extendedZone)
    );
  }
